...
Revision ID: f94ab8091c80
Revises: ffdc0a98111c
Create Date: 2021-08-21 23:08:41.662408
...
def upgrade():
    ...
    op.add_column('users', sa.Column(
        'first_name', sa.String(length=100), nullable=False))
    op.add_column('users', sa.Column(
        'last_name', sa.String(length=100), nullable=False))
